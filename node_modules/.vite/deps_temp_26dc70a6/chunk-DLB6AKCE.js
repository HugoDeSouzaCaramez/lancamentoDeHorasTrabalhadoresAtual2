...
import {
  ...
  require_promises,
  require_tty
} from "./chunk-PJUNNFNB.js";
import {
  require_node_http
} from "./chunk-HO7OSK64.js";
import {
  require_node_https
} from "./chunk-3NWPCB5S.js";
import {
  require_node_module,
  require_node_url
} from "./chunk-UQC37NDZ.js";
import {
  require_node_path
} from "./chunk-JQENMGEB.js";
import {
  require_url
...
function getOriginalPosition(map, { line, column }) {
  ...
  map._decodedMemo ?? (map._decodedMemo = memoizedState());
...
var ViteRuntime = class {
  ...
  clearCache() {
    ...
    (_a = this.hmrClient) == null ? void 0 : _a.clear();
  }
  /**
  ...
  async destroy() {
    var _a;
    (_a = this._resetSourceMapSupport) == null ? void 0 : _a.call(this);
    this.clearCache();
  ...
  async cachedRequest(id, fetchedModule, callstack = [], metadata) {
    ...
    if (metadata == null ? void 0 : metadata.entrypoint) {
...
${getStack()}`);
  ...
  async directRequest(id, fetchResult, _callstack) {
    ...
    if (this.hmrClient) {
      Object.defineProperty(meta, "hot", {
        ...
        get: () => {
          ...
          (_a2 = this.debug) == null ? void 0 : _a2.call(this, "[vite-runtime] creating hmr context for", moduleId);
          hotContext || (hotContext = new HMRContext(this.hmrClient, moduleId));
          return hotContext;
        },
        set: (value) => {
          hotContext = value;
    ...
    (_b = this.debug) == null ? void 0 : _b.call(this, "[vite-runtime] executing", href);
...
function analyzeImportedModDifference(mod, rawId, moduleType, metadata) {
  ...
  if (moduleType === "module")
    return;
  if ((_a = metadata == null ? void 0 : metadata.importedNames) == null ? void 0 : _a.length) {
...
//# sourceMappingURL=chunk-DLB6AKCE.js.map
